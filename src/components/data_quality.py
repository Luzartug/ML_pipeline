...
class DataQualityConfig:
    processed_data_path: str = os.path.join('data','data_quality.csv')
...
if __name__ == "__main__":
    input_data_path = 'data/raw/raw.csv'
    data_quality_instance = DataQuality(input_data_path)
    ...
    if processed_data_path:
        ...
        logging.info("Data quality checks and no corrections")